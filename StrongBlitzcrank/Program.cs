...
namespace StrongBlitzcrank
{
    class Program
    {
        private static string Name = "Strong Blitzcrank";
        ...
        private static void Combo()
        {
            ...
            if (useR && Target.IsValidTarget(R.Range) && Player.CountEnemysInRange(R.Range) >= minR && R.IsReady() || Target.Health <= R.GetDamage(Target))
            {
